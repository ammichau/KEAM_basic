...
global beta crra eta mu r xi z_h tau_wf alpha_e delta_e psi phi_c gam_e ybar_h  alpha_h
 ...
 %Aging Probabilities- 18-24; 25-39; 40-54; 55-64; 65-80
    ...
    tsize = 4; %quarterly
    piT = [1-1/(14*tsize), 1/(14*tsize), 0, 0 ; 0, 1-1/(14*tsize), 1/(14se*tsize), 0; 0,0 1-1/(8*tsize) , 1/(8*tsize); ];
    tgrid=(1:1:nT-1);
...
% ----- Generate a non-linear grid for experience 
        ...
        egrid= 2*(egrid.^1.5);
    medwage = (wage(ftW(nI),egrid(floor(nE/2)))+wage(ftW(1),egrid(floor(nE/2))))/2
